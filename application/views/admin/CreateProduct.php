...
<body class="d-flex flex-column min-vh-100">
  ...
  <div class="row flex-grow-1 m-0">
    ...
    <div class="col-md-10 bg-light">
      <h1>Thêm sản phẩm</h1>
      <hr>
      <form action="<?php echo base_url('admin/products/insert_product') ?>" method="post" class="mr-4 text-center"
        enctype="multipart/form-data">
        <h4>Thông tin cơ bản</h4>
        <label for="product_name" class="col-md-2">Tên sản phẩm: </label>
        <input class="p-2 m-2 col-md-6 rounded" type="text" name="product_name" id="product_name" required
          autofocus><br />
        ...
        <div class="col-md-8 ml-4 p-4 d-inline">
          ...
          <button type="button" class="btn bg-danger m-2 text-decoration-none">
            <a href="<?php echo base_url('admin/products') ?>"
              class="text-decoration-none text-dark font-weight-bold">Hủy</a>
          </button>
        </div>
      </form>
    </div>
