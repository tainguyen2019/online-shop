...
<body class="d-flex flex-column min-vh-100">
  ...
  <div class="row flex-grow-1 m-0">
    ...
    <div class="col-md-10 bg-light">
      ...
      <hr>
      <form action="<?php echo base_url('admin/promotions/edit_promotion') ?>" method="post" class="mr-4 text-center" enctype="multipart/form-data">
        ...
        <select class="custom-select p-2 m-2 col-md-6 rounded form-control-lg" id="product" name="product">
          <?php foreach ($products as $product) { ?>
            <option value="<?php echo $product['product_id']; ?>" <?php if ($product['product_id'] == $promotion->product_id) echo 'selected'; ?>>
        ...
        value="<?php echo $promotion->valid_date ?>" required><br />
        ...
        value="<?php echo $promotion->expiry_date?>" required><br />

        <label for="quantity" class="col-md-2">Giảm giá: </label>
        <input class="p-2 m-2 col-md-6 rounded" type="number" name="discount" 
        id="discount" min="1" max="99" value="<?php echo $promotion->discount * 100 ?>" required><br />

        <input type="hidden" value="<?php echo $promotion->promotion_code ?>" name="promotion_code">
