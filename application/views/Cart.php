          ...
          <div class="col-right">
            ...
            <div class="badge-cart-a">
              <div class="box-size">
                ...
                <div class="sub-total">
                  <p> Giá tạm thời: </p>
                  <p class="price"><?= $this->cart->format_number($Item['subtotal']) ?></p>
                </div>-->
              </div>
            </div>
                  ...
                  <div class="panel-body">
                    <div class="input-group">
                      <input id="coupon" class="form-control" name="discount" type="text"
                        placeholder="Nhập ở đây.."></input>
                      <span class="input-group-btn">
                        <input class="btn btn-default btn-coupon" type="submit" id="discount"
                          value="Đồng ý"></input></button>
                      </span>
                    </div>
                  </div>
                </div>
