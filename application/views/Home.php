		...
		<div id="myCarousel" class="carousel slide border" data-ride="carousel">
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img class="d-block w-100 img-fluid" src="<?php echo base_url(); ?>public/images/slide_show-1.jpeg" alt="Cat">
				</div>
				<div class="carousel-item">
					<img class="d-block w-100 img-fluid" src="<?php echo base_url(); ?>public/images/slide_show-2.jpeg" alt="Lion">
				</div>
				<div class="carousel-item">
					<img class="d-block w-100 img-fluid" src="<?php echo base_url(); ?>public/images/slide_show-3.jpeg" alt="Lion">
				</div>
				<div class="carousel-item">
					<img class="d-block w-100 img-fluid" src="<?php echo base_url(); ?>public/images/slide_show-4.jpeg" alt="Lion">
				</div>
				<!-- Controls -->
	...
	<main>
			...
			<section id="headphone" class="introduction">
				...
				<div class="intro-content">
					<div class="left advertisement-img col-4">
						<img class="card-img-top bg-light img-product-effect" src="<?php echo base_url(); ?>public/images/headphone_advertising.jpg">
					</div>
							...
							foreach ($show_headphone as $key => $val) {
								...
								<div class="card product-card">
									<a href="<?php echo base_url('product/show_product_info/' . $val['product_id']) ?>">
										<img class="card-img-top bg-light img-product-effect" src="<?php echo base_url('public/images/') . $val['image']; ?>">
									...
									<div class="card-body card-body-size" style="position : relative">
										...
										<p class="card-text product-price">
											<?php echo number_format($val['price'], 0, '', '.') . ' VND'; ?></p>
										<a class="btn btn-effect btn-outline-dark" href="<?php echo base_url('cart/AddtoCart/' . $val['product_id']) ?>">
											Mua ngay
										</a>
										<img src="https://img.icons8.com/bubbles/70/000000/gift.png" style="margin-left: 20px;">
									</div>
								</div>
							<?php } ?>
		...
		<div class="introduction-box">
			<section id="mouse" class="introduction">
				...
				<div class="intro-content">
					<div class="left advertisement-img col-4">
						<img class="card-img-top bg-light img-product-effect" src="<?php echo base_url(); ?>public/images/mouse_advertising.jpg">
					</div>
					<div class="right list-product col-8">
						<div class="list-product">
							<?php
		...
		<div class="introduction-box">
			<section id="keyboard" class="introduction">
				...
				<div class="intro-content">
					<div class="left advertisement-img col-4">
						<img class="card-img-top bg-light img-product-effect" src="<?php echo base_url(); ?>public/images/keyboard_advertising.jpg">
					</div>
					<div class="right list-product col-8">
						<div class="list-product">
							<?php
		...
		<div class="introduction-box">
			<section id="speaker" class="introduction">
				...
				<div class="intro-content">
					<div class="left advertisement-img col-4">
						<img class="card-img-top bg-light img-product-effect" src="<?php echo base_url(); ?>public/images/speaker_advertising.jpg">
					</div>
					<div class="right list-product col-8">
						<div class="list-product">
							<?php
