          ...
          -->
			...
			<div class="carousel-inner">
				...
				<div class="carousel-item">
					<img class="d-block w-100" src="<?php echo base_url(); ?>public/images/slide_show-2.jpeg" alt="Lion">
				</div>
				<div class="carousel-item">
					<img class="d-block w-100" src="<?php echo base_url(); ?>public/images/slide_show-3.jpeg" alt="Lion">
				</div>
				<div class="carousel-item">
					<img class="d-block w-100" src="<?php echo base_url(); ?>public/images/slide_show-4.jpeg" alt="Lion">
				</div>
				<!-- Controls -->
